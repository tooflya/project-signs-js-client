...
Achievements = Screen.extend({
  ctor: function() {
    ...
    this.m_BackButton.setTouchHandler('onBackEvent', Achievements);
  },
...
Achievements.sharedScreen = function() {
  return Achievements.instance ? Achievements.instance : new Achievements();
};
